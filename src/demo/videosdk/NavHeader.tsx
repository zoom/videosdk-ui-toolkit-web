...
import { resourceLinks, videoToolLinks, zfgLinks, AILinks } from "../resource";
...
const HeaderLinks: HeaderLink[] = [
  {
    text: "Old Nav",
    url: "https://videosdk.zoomdev.us/old.html",
    title: "video sdk nav old",
  },
  videoToolLinks,
  resourceLinks,
  zfgLinks,
      ...
      <div className="mx-auto flex flex-col sm:flex-row justify-between items-center">
        <div className="flex items-center mb-4 sm:mb-0">
          <a href="/" className="flex items-center hover:opacity-80 transition-opacity">
            ...
            <span className="text-lg text-theme-text ml-2">VideoSDK-Web</span>
          </a>
        </div>
