    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center text-black ">
      <div className="bg-white rounded-lg max-w-md w-full">
        <div className="flex justify-between items-center border-b p-4">
          <h2 className="text-lg font-semibold">{t("how.to_allow")}</h2>
        ...
        <div className="p-4 max-h-[70vh] overflow-y-auto uikit-custom-scrollbar">
          {!isMobileDevice() && (
            <>
              <p className="mb-2">1. {t("click.address_bar")}</p>
              <p className="mb-2">2. {t("click.microphone_camera_option")}</p>
              <p className="mb-4">3. {t("select.allow")}</p>
            </>
          )}
